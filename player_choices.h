...
int player1_choices(void){
    ...
    case 1:
        if(marker_postion[2][0] == 79 || marker_postion[2][0] == 88 ){
            player1_choices();
            break;
        }
    ...
    case 2:
        if(marker_postion[2][1] == 79 || marker_postion[2][1] == 88){
            player1_choices();
            break;
        }
    ...
    case 3:
        if(marker_postion[2][2] == 79 || marker_postion[2][2] == 88){
            player1_choices();
            break;
        }
    ...
    case 4:
        if(marker_postion[1][0] == 79 || marker_postion[1][0] == 88){
            player1_choices();
            break;
        }
    ...
    case 5:
        if(marker_postion[1][1] == 79 || marker_postion[1][0] == 88){
            player1_choices();
            break;
        }
    ...
    case 6:
        if(marker_postion[1][2] == 79 || marker_postion[1][2] == 88){
            player1_choices();
            break;
        }
    ...
    case 7:
        if(marker_postion[0][0] == 79 || marker_postion[0][0] == 88){
            player1_choices();
            break;
        }
    ...
    case 8:
        if(marker_postion[0][1] == 79 || marker_postion[0][1] == 88){
            player1_choices();
            break;
        }
    ...
    case 9:
        if(marker_postion[0][2] == 79 || marker_postion[0][2] == 88){
            player1_choices();
            break;
        }
...
int player2_choices(void){
    ...
    case 1:
        if(marker_postion[2][0] == 88 || marker_postion[2][0] == 79){
            player2_choices();
            break;
        }
    ...
    case 2:
        if(marker_postion[2][1] == 88 || marker_postion[2][1] == 79){
            player2_choices();
            break;
        }
    ...
    case 3:
        if(marker_postion[2][2] == 88 || marker_postion[2][2] == 79){
            player2_choices();
            break;
        }
    ...
    case 4:
        if(marker_postion[1][0] == 88 || marker_postion[1][0] == 79){
            player2_choices();
            break;
        }
    ...
    case 5:
        if(marker_postion[1][1] == 88 || marker_postion[1][1] == 79){
            player2_choices();
            break;
        }
    ...
    case 6:
        if(marker_postion[1][2] == 88 || marker_postion[1][2] == 79){
            player2_choices();
            break;
        }
    ...
    case 7:
        if(marker_postion[0][0] == 88 || marker_postion[0][0] == 79){
            player2_choices();
            break;
        }
    ...
    case 8:
        if(marker_postion[0][1] == 88 || marker_postion[0][1] == 79){
            player2_choices();
            break;
        }
    ...
    case 9:
        if(marker_postion[0][2] == 88 || marker_postion[0][2] == 88){
            player2_choices();
            break;
        }
